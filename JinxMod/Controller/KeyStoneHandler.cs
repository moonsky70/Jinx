...
namespace JinxMod.Controller
{
    public class KeyStoneHandler : NetworkBehaviour, IOnDamageDealtServerReceiver, IOnTakeDamageServerReceiver
    {
        ...
        public void OnDamageDealtServer(DamageReport damageReport)
        {
            ...
            if (damageReport.victimBody && damageReport.attacker && damageReport.attackerBody.baseNameToken == JinxPlugin.DEVELOPER_PREFIX + "_JINX_BODY_NAME")
            {
                UptimeStopwatch = 0f;
        ...
        {
            if (this.keyStone.skillNameToken == "JINX_CONQUEROR_NAME") this.keyStoneType = KeyStones.Conqueror;
            if (this.keyStone.skillNameToken == "JINX_LETHAL_NAME") this.keyStoneType = KeyStones.Lethal;
            if (this.keyStone.skillNameToken == "JINX_PHASE_RUSH_NAME") this.keyStoneType = KeyStones.PhaseRush;
            if (this.keyStone.skillNameToken == "JINX_ELECTROCUTE_NAME") this.keyStoneType = KeyStones.Electrocute;
        }
